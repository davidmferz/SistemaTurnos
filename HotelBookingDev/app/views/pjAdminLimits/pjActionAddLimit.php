...
<form action="" method="post" class="pj-form form">
	...
	<p>
		...
		<span class="block">
			<input type="text" name="min_nights" id="al_min_nights" class="pj-form-field w80 required" readonly="readonly" />
		</span>
	</p>
	<p>
		<label class="title"><?php __('limit_max_nights'); ?></label>
		<span class="block">
			<input type="text" name="max_nights" id="al_max_nights" class="pj-form-field w80 required nightsValidate" readonly="readonly" data-msg-nightsValidate="<?php __('lblNightsValidation');?>"/>
		</span>
	</p>
</form>